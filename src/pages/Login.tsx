        ...
        <div className="w-full max-w-sm space-y-5">
          ...
          {mode !== 'confirm' && (
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-[12px] border border-border bg-background py-2.5 text-sm font-semibold text-foreground hover:bg-muted/50 transition-colors"
            >
